				...
				<div class="row row-grid">
					<div class="col-sm-8">
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="form-group">
									<label class="aq-component-label"><span class="mandatory-fields">*</span> Question : </label>
									<i class="fa fa-info-circle helpIcon" data-placement="right" data-toggle="tooltip" title="Enter a Question Statement"></i>
									<div class="data-insert-panel" id="mcqQuestionStatement"></div>
								</div>
							</div>
						</div>
						...
						<div class="row row-grid">
							<div class="col-sm-12">
								<div class="form-group">
									<label class="aq-component-label"><span class="mandatory-fields">*</span> Answer Choices : </label>
									<i class="fa fa-info-circle helpIcon" data-placement="right" data-toggle="tooltip" title="Enter a Answer Choice"></i>
								</div>
							</div>
							<div class="col-sm-11">
								<div id="answerChoiceContainer" class="row">
									<div class="col-sm-6">
										<div class="data-insert-panel" id="anserChoice_1"></div>
									</div>
									<div class="col-sm-6">
										<div class="data-insert-panel" id="anserChoice_2"></div>
									</div>
								</div>
							</div>
							<div class="col-sm-1">
								<button type="button" class="btn btn-primary" id="addElement" style="cursor: pointer;"><i class="fa fa-plus" aria-hidden="true"></i></button>
							</div>
						</div>
...
<script src="<c:url value='/resources/js/custom/multiple-choice.js'/>"></script>
<script src="<c:url value='/resources/js/custom/dynamic-element.js'/>"></script>
<script src="<c:url value='/resources/js/custom/meta-info.js'/>"></script>
