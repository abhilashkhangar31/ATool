				...
				<div class="row">
					<div class="col-sm-8">
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="form-group">
									...
									<div class="data-insert-panel" id="mtpQuestionStatement"></div>
								</div>
							</div>
						</div>
						...
						<div class="row row-grid">
							<div class="col-sm-12">
								<div class="form-group">
									<label class="aq-component-label">Groups Headers : </label>
									<i class="fa fa-info-circle helpIcon" data-placement="right" data-toggle="tooltip" title="Enter a Group Headers."></i>
									<div class="row">
										<div class="col-sm-6">
						...
						<div class="row row-grid">
							<div class="col-sm-12">
								<div class="form-group">
									<label class="aq-component-label">Answer Choice Groups : </label>
									<i class="fa fa-info-circle helpIcon" data-placement="right" data-toggle="tooltip" title="Enter a Answer Choice Groups"></i>
									<div class="row">
										<div class="col-sm-6">
											<div class="data-insert-panel" id="mtpAnswerChoice_1"></div>
										</div>
										<div class="col-sm-6">
											<div class="data-insert-panel" id="mtpAnswerChoice_2"></div>
										</div>
									</div>
								</div>
							</div>
...
<script src="<c:url value='/resources/js/custom/match-the-pair.js'/>"></script>
