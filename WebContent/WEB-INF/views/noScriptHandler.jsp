...
<body>
		        ...
		        <div class="col-sm-6">
		            <noscript>
			            <div class="box">
			                ...
			                <div class="info">
			                    <h4 class="text-center">JavaScript Required</h4>
			                    <p>We're sorry, but we doesn't work properly without JavaScript enabled. Please enable JavaScript and click on <b>Reload Page</b> button.</p>
			                    <a href="${requestUrl}" class="btn"><b>Reload Page</b></a>
			                    <a href="${pageContext.request.contextPath}/logout" class="btn"><b>Logout</b></a>
			                </div>
			            </div>
		            </noscript>
		        </div>
	...
	<script type="text/javascript">window.location.href = '${requestUrl}';</script>
</body>
</html>